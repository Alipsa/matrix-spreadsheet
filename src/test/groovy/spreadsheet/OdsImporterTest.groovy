...
import se.alipsa.groovy.spreadsheet.OdsImporter

class OdsImporterTest {

  @Test
  void testOdsImport() {
    def table = OdsImporter.importOds(file: "Book1.ods", endRow: 11, endCol: 4, firstRowAsColNames: true)
  ...
  void TestImportWithColnames() {
    def table = OdsImporter.importOds(
        "file": "Book1.ods",
        "endRow": 11,
        "startCol": 'A',
        "endCol": 'D'
